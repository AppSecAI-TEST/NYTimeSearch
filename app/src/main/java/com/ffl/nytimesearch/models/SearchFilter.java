...
public class SearchFilter implements Serializable {
    ...
    public Bundle toBundle() {
        Bundle b = new Bundle();
        if (this.beginDateTimes!= null) {
            b.putLong(BEGIN_DATE_TIMESTAMP_ID, this.beginDateTimes);
        }
    ...
    public void setBeginDate(int year, int month, int day) {
        ...
        beginDateTimes = calendar.getTime().getTime();
    }

    public void setBeginDateTimestamp(Long timestamp) {
        if (timestamp > 0) {
            beginDateTimes = timestamp;
        } else {
            beginDateTimes = null;
        }
    }
    ...
    public Long getBeginDateTimestamp() {
        return beginDateTimes;
    }

    public String getBeginDate(String format) {
        CharSequence str = "";
        if (beginDateTimes != null) {
            str = android.text.format.DateFormat.format(format, beginDateTimes);
        }
        return str.toString();
    }
